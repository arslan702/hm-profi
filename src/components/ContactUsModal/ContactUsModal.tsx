...
import Style from "./contactUsModal.module.scss";
  ...
  return (
    <div
      className={`${Style.contactUsModal} ${
        isContactUsModalOpen ? Style.active : ""
      }`}
      ...
      >
        ...
        <div className={Style.info}>
          <a href="tel:+49 2297 81900-08">
            <img src="/images/icons/phone-1.webp" alt="" />
          ...
          <div className={Style.location}>
            <img
						  src="/images/icons/location.webp"
						  srcSet="/images/icons/location.webp 1x, /images/icons/location@2x.webp 2x"
						  sizes="(max-width: 450px) 24px, 30px"
						  width="24"
						  alt=""
						  decoding="async"
						/>
          ...
          <div
            className={Style.faqIcon}
            onClick={() => {
              setIsContactUsModalOpen(false);
              router.push("/application/question-and-answer");
            }}
          >
            ...
            >
              <img src="/images/icons/FAQ.webp" alt="" />
            </div>
